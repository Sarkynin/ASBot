...
class HelpPlugin
  ...
  def initialize(*args)
    ...
    @commands = {
      ...
      "asbrank" => "!asbrank <pokemon> - Gives a Pokémon's rank in ASB.",
      "asbtype" => "!asbtype <type> - Gives a type's attributes and exclusive commands in ASB.",
      ...
      "source" => "https://github.com/lc-guy/asbot",
